...
Class Notif	{
    ...
    private function getConnectedUserNotifsInfos() {
        $this->connectedUser_validationNotifsInfos = $this->notif_service->getUnvalidatedOrders(+$this->params['validationTime'], $_SESSION['id_external_user']);
        $this->connectedUser_paymentNotifsInfos = $this->notif_service->getUnpaidOrders(+$this->params['paymentTime'], $_SESSION['id_external_user']);
        $this->connectedUser_recoveryNotifsInfos = $this->notif_service->getUnrecoveredOrders(+$this->params['recoveryTime'], $_SESSION['id_external_user']);
    }
