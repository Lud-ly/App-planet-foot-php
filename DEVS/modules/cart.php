...
Class Cart	{
     ...
     */
    private function checkPromoReference() {
        ...
        $this->promoUsedByUserCount = $this->obj_service->getUsedPromoReferenceByUserCount(
            $_SESSION['id_external_user'],
        ...
        $this->obj_service->cancelUserPromoReferenceUse(
            $_SESSION['id_external_user'],
            $this->VARS_HTML['promo_code']
        );
     ...
     * Return the result to the JS.
     */
    private function cancelPromoReference() {
        if ( isset($this->VARS_HTML['promo_code']) ) {
            $result = $this->obj_service->cancelUserPromoReferenceUse(
                $_SESSION['id_external_user'],
                $this->VARS_HTML['promo_code']
            );
