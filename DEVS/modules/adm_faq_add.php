...
/**
 * Class Adm_faq_add | fichier adm_faq_add.php
 *
...
class Adm_faq_add
{
    ...
    /**
     * Get interface to gestion of adm_faq_add
     */
    function main()
    {
    ...
    private function checkFaqForm()
    {
        ...
        /*********************answer ***********************/
        if (!isset($this->VARS_HTML["reponse"]) || ($this->VARS_HTML["reponse"] == "")) {
