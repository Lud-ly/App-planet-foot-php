...
class Admin_service extends Initialize	{
     ...
     * 
     * @param string|int $userId? The user id. Connected user if null.
     * 
     * @return int
     */
     ...
     * @param bool|string|int $userRole The new user role
     * 
     * @return array
     */
    public function updateRole($userId, $userRole)
    {
        ...
        if ($userRole == 4) {
            ...
            if ($connectedUserRole != 4 ) {
                // ◘◘◘ hacking attempt !! ◘◘◘
                Log::hacking_attempt("id_personne_connectée: $userId. role_personne_connectée: $connectedUserRole ◘◘ id_personne_ciblée: $userId, role_personne_ciblée: $userRole");
                return [
     ...
     * 
     * @param integer|string $userId The user id
     * @param bool|string|int $userStatus The new user status
     * 
     * @return array
     */
